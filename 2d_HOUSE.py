...
# Draw the grass platform
def draw_grass_platform():
    set_color(context, 0.5, 0.8, 0.4)  # Green
    context.rectangle(200, 500, 600, 200)  # Enlarge platform
    context.fill()
...
# Save to file
surface.write_to_png("improved_isometric_house_v2.png")
print("Improved isometric house image saved as improved_isometric_house_v2.png")
